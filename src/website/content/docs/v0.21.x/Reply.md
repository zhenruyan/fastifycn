...
```
*Take a look [here](/docs/v0.21.x/Validation-And-Serialize#serialize) to understand how serialize is done.*
...
```
If you want it extend this error, check out [`extendServerError`](/docs/v0.21.x/Decorators#extend-server-error).  
