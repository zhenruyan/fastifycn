...
path: /docs/v0.25.x/Getting-Started
version: v0.25.x
...
```
*If you want to know more about the serialization and validation, check [here](/docs/v0.25.x/Validation-And-Serialize)!*
...
Check the documentation folder [here](/docs/v0.25.x/)!
