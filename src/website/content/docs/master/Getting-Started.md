...
path: /docs/master/Getting-Started
version: master

github_url: https://github.com/fastify/fastify/blob/master/docs/Getting-Started.md
---
...
Do you prefer to use `async/await`? Please review [Routes#async-await](/docs/master/Routes#async-await)!
...
*To learn more about using serialization and validation, see [Validation and Serialization](/docs/master/Validation-and-Serialization)!*
...
<a name="next"></a>
### Next
Do you want to learn more? Check out the documentation folder located [here](/docs/master/)!
