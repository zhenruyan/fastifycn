...
path: /docs/master/Reply
version: master

github_url: https://github.com/fastify/fastify/blob/master/docs/Reply.md
---
...
```
*Take a look [here](/docs/master/Validation-and-Serialization#serialization) to understand how serialization is done.*
...
If you want to know more please review [Routes#async-await](/docs/master/Routes#async-await)!
...
```
If you want it extend this error, check out [`extendServerError`](/docs/master/Decorators#extend-server-error).
