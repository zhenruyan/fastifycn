...
path: /docs/master/Logging
version: master

github_url: https://github.com/fastify/fastify/blob/master/docs/Logging.md
---
...
*The logger instance for the current request is available in every part of the [lifecycle](/docs/master/Lifecycle).*
