...
path: /docs/master/Decorators
version: master

github_url: https://github.com/fastify/fastify/blob/master/docs/Decorators.md
---
...
**extendServerError**
If you need to extend the standard [server error](/docs/master/Reply#errors), this API is what you need. You *must* pass a function that returns an object, and Fastify will extend the server error with the object returned by your function. The function will receive the original error object:
```js
