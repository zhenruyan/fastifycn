...
path: /docs/master/Middlewares
version: master

github_url: https://github.com/fastify/fastify/blob/master/docs/Middlewares.md
---
...
*If you need a visual feedback to understand when the middlewares are executed take a look to the [lifecycle](/docs/master/Lifecycle) page.*
...
Remember that middlewares can be encapsulated, this means that you can decide where your middlewares should run by using `register` as explained in the [plugins guide](/docs/master/Plugins-Guide).
