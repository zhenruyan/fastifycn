...
path: /docs/latest/Middlewares
version: latest
canonical: "/docs/v0.33.x/Middlewares"
...
*If you need a visual feedback to understand when the middlewares are executed take a look to the [lifecycle](/docs/latest/Lifecycle) page.*
...
Remember that middlewares can be encapsulated, this means that you can decide where your middlewares should run by using `register` as explained in the [plugins guide](/docs/latest/Plugins-Guide).
