...
path: /docs/latest/Getting-Started
version: latest
canonical: "/docs/v0.33.x/Getting-Started"
...
Do you prefer to use `async/await`? Please review [Routes#async-await](/docs/latest/Routes#async-await)!
...
*To learn more about using serialization and validation, see [Validation and Serialization](/docs/latest/Validation-and-Serialization)!*
...
<a name="next"></a>
### Next
Do you want to learn more? Check out the documentation folder located [here](/docs/latest/)!
