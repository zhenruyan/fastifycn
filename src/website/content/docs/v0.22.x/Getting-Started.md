...
path: /docs/v0.22.x/Getting-Started
version: v0.22.x
...
```
*If you want to know more about the serialization and validation, check [here](/docs/v0.22.x/Validation-And-Serialize)!*
...
Check the documentation folder [here](/docs/v0.22.x/)!
