...
```
*Take a look [here](/docs/v0.30.x/Validation-and-Serialization#serialization) to understand how serialization is done.*
...
```
If you want to know more please review [Routes#async-await](/docs/v0.30.x/Routes#async-await)!
...
```
If you want it extend this error, check out [`extendServerError`](/docs/v0.30.x/Decorators#extend-server-error).
