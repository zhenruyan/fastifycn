...
```
*Take a look [here](/docs/v0.29.x/Validation-And-Serialize#serialize) to understand how serialize is done.*
...
```
If you want to know more please review [Routes#async-await](/docs/v0.29.x/Routes#async-await)!
...
```
If you want it extend this error, check out [`extendServerError`](/docs/v0.29.x/Decorators#extend-server-error).  
