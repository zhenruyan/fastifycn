...
```
*Take a look [here](/docs/v0.31.x/Validation-and-Serialization#serialization) to understand how serialization is done.*
...
If you want to know more please review [Routes#async-await](/docs/v0.31.x/Routes#async-await)!
...
```
If you want it extend this error, check out [`extendServerError`](/docs/v0.31.x/Decorators#extend-server-error).
